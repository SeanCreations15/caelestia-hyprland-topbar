...
PathView {
    ...
    readonly property int numItems: {
        ...
        const barMargins = Math.max(Config.border.thickness, panels.bar.implicitHeight);
        let outerMargins = 0;
        if (panels.popouts.hasCurrent && panels.popouts.currentCenter + panels.popouts.nonAnimWidth / 2 > screen.width - content.implicitWidth - Config.border.thickness * 2)
